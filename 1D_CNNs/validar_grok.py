...
def main():
    input_filepath = 'dataset_sintetico_grok.json'
    ...
    print("\n--- AVALIAÇÃO: dataset_sintetico_grok.json ---")
    ...
    plt.title('Matriz de Confusão (Grok)')
    plt.ylabel('Classe Real')
    plt.xlabel('Classe Prevista')
    plt.tight_layout()
    plt.savefig('matriz_confusao_grok.png')
    plt.close()
    
    print("Matriz de Confusão salva como 'matriz_confusao_grok.png'")
